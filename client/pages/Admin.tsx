  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mt-1 text-muted-foreground">
        System management, user oversight, content moderation, and analytics.
      </p>
      ...
      <section className="mt-8 overflow-hidden rounded-xl border">
        ...
        <ul className="divide-y">
          {["Flagged post in Chemistry", "Reported comment in Algebra"].map(
            (i) => (
              <li
                key={i}
              ...
              >
                ...
                <div className="space-x-2">
                  ...
                  <button className="rounded-md bg-destructive px-3 py-1 text-destructive-foreground hover:bg-destructive/90">
                    Remove
                  </button>
                </div>
              </li>
