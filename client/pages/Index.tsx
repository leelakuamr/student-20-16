    ...
    <div>
      ...
      <section className="container mx-auto px-4 py-20">
        <h2 className="text-center text-3xl font-bold">
          Everything learners and educators need
        </h2>
        <p className="mx-auto mt-2 max-w-2xl text-center text-muted-foreground">
          Built for students, instructors, admins, and parents with powerful
          tools and a delightful experience.
        </p>
        ...
        <div className="container mx-auto grid gap-6 px-4 md:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            },
            {
              ...
              items: ["Course creation", "Student management", "Grading"],
            },
            {
              role: "Student",
              items: [
            ...
            },
            {
              ...
              items: ["Child progress", "Teacher communication"],
            },
          ].map((r) => (
            <div
              key={r.role}
              className="rounded-xl border bg-white/70 p-6 shadow-sm backdrop-blur dark:bg-background"
            >
          ...
          <div className="items-center justify-between rounded-2xl border bg-gradient-to-r from-primary/10 to-secondary/10 p-8 md:flex">
            <div>
              ...
              <p className="mt-1 text-muted-foreground">
                Start with a sample student dashboard and explore real features.
              </p>
            </div>
